...
Feature: Crear factura y boleta
    ...
    Scenario Outline:Crear factura con producto afecto,inafecto,exonerado ,con ruc ,medio pago y destino caja diaria.
        Given que estoy en la pagina de creacion,selecciono tipo factura
        ...
        Examples:
            ...
            | item1       | item2         | item3          | 20202020201 | efectivo              | caja venta 1 |
            | item1       | item2         | item3          | 20202020201 | Tarjeta de crédito    | caja venta 1 |
            | item1       | item2         | item3          | 20202020201 | Tarjeta de débito     | caja venta 1 |
